      ...
      <div className="min-h-screen flex flex-col p-6 md:p-12">
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <div className="w-16 h-1 bg-border rounded-full mb-4"></div>
            <div className="flex items-center gap-3">
              <Badge variant={isSessionComplete ? "outline" : "secondary"}>
                {isSessionComplete
                  ? "Sesi Selesai"
                  : "Debat Sedang Berlangsung"}
              </Badge>
              <Separator orientation="vertical" className="h-5" />
              <Badge variant="outline">Durasi: {session.duration} detik</Badge>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            <Card className="text-center p-12 max-w-2xl">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Semua {session.candidates.length} pasangan calon telah
