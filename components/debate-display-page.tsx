...
export default function DebateDisplayPage({
    session,
    onSessionEnd,
}: DebateDisplayPageProps) {
    ...
    return (
        <div className="min-h-screen bg-background overflow-hidden">
            ...
            {!isSessionComplete && (
              <Button variant="ghost" onClick={onSessionEnd} className="z-10">
                ← Kembali
              </Button>
            )}
          </div> 
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center">
                        <Card className="text-center p-12 max-w-2xl">
                            ...
                            <p className="text-lg text-muted-foreground mb-6">
                                Semua {session.candidates.length} kandidat telah
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center gap-8">
                        {showCandidates && !showTimer && (
                            <div className="w-full flex flex-col">
                                <div className="max-w-8xl px-28 mx-auto grid lg:grid-cols-3 gap-20 mb-8 ">
                                    ...
                                    <div className="flex flex-col gap-12 justify-center  col-span-2">
                                ...
                                <div className="flex justify-center fixed bottom-10 left-1/2 -translate-x/12">
                                    <Button
                                        size="lg"
