...
export default function CandidateDisplay({ candidate }: CandidateDisplayProps) {
    return (
        <div className="flex justify-center relative ">
            ...
            />
            <Card className="absolute bottom-0 text w-full translate-y-1/2">
                <CardHeader>
                    <CardDescription className="text-3xl font-extrabold text-primary">{candidate.role}</CardDescription>
                    <CardTitle className="text-5xl font-bold">{candidate.name}</CardTitle>
                </CardHeader>
            </Card>
        </div>
    );
